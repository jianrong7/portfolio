...
const ninetyNineCoMetaTags = {
  ...
  keywords:
    "Frontend Development, 99.co, Singapore's Fastest Growing Property Marketplace, React, Redux",
  image:
...
const traceifyMetaTags = {
  ...
  keywords: "Frontend Development, Traceify, Spotify, TraceTogether, React",
  image:
    "https://yt3.ggpht.com/ytc/AKedOLTDhrtaDgYv5BNYjZ6AZLVbTvH7a7AYzV32GjGZ=s900-c-k-c0x00ffffff-no-rj",
};

      ...
      <main className={styles.main}>
        ...
        <section id="about">
          ...
          <p>
            ...
            and scalable code. I made sure to bring consistency in UX and
            tooling across my projects. I recently joined 99.co as a frontend
            engineer where my work will consist of constructing beautiful UI
            components to help 99% of people find their homes. When not online,
            I love working out and reading about all kinds of things.
          </p>
